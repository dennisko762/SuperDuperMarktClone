...
public class ProductFactoryTest {
    ...
    void createProductTest() {
        ...
        assertInstanceOf(Cheese.class, ProductFactory.createProduct(productType, "test-description", 0.00, 100, LocalDate.now()));

        productType = Type.WINE;
        assertInstanceOf(Wine.class, ProductFactory.createProduct(productType, "test-description", 0.00, 100, LocalDate.now()));
